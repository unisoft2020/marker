...
function download_file(name, type, data) {
	...
	//if (data != null && window.navigator.msSaveBlob) return window.navigator.msSaveBlob(data, name);
...
function is_email(value) {
	if (value.match(/[a-z0-9][a-z0-9\_\.\-]+[@]([a-z0-9]{1,2}|[a-z0-9][a-z0-9\-]+[a-z0-9])([\.][a-z]+){1,3}/i)) return true;
	return false;
}
...
function is_date(d, m, y) {
	...
	if (d == 29 && m == 2) return (((y % 4 == 0) && (y % 100 != 0)) || (y % 400 == 0)) ? true : false;
	return true;
}
